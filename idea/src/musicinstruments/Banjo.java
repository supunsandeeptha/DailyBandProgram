...
/**
 Banjo class inherits from the Instrument abstract class as it's a musical instrument.
 */
public class Banjo extends Instrument {
    ...
    //constructor
    public Banjo(String instrumentName, String instrumentManufacturer,int noOfString, float stringSize) {
    ...
    public String toString() {
        return "Instrument is " + getInstrumentName() + ". Made by " + getInstrumentManufacturer() +
           ". Properties are: " + "No of Strings are " + noOfString +
